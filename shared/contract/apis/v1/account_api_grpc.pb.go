...
func (c *accountServiceClient) CreateSchoolProfile(ctx context.Context, in *CreateSchoolProfileRequest, opts ...grpc.CallOption) (*CreateSchoolProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateSchoolProfileResponse)
	err := c.cc.Invoke(ctx, AccountService_CreateSchoolProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountService_CreateSchoolProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSchoolProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).CreateSchoolProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_CreateSchoolProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).CreateSchoolProfile(ctx, req.(*CreateSchoolProfileRequest))
	}
