...
import "github.com/ritchieridanko/klasshub/services/school/internal/constants"
...
var AuthPolicies map[string]AuthPolicy = map[string]AuthPolicy{
	"/school.v1.SchoolService/CreateSchool": AuthPolicy{
		requireAuth:         true,
		requireSchool:       false,
	...
	"/school.v1.SchoolService/GetMe": AuthPolicy{
		requireAuth:         true,
		requireSchool:       true,
