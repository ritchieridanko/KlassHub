...
const (
	...
	CodeIdentifierNotProvided   errCode = "ERR_IDENTIFIER_NOT_PROVIDED"
	...
	CodeUsernameNotAvailable    errCode = "ERR_USERNAME_NOT_AVAILABLE"
...
const (
	...
	MsgIdentifierNotProvided string = "No email or username is provided"
	...
	MsgUsernameNotAvailable  string = "Username is already registered"
)
